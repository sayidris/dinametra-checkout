            ...
            <div style="display:inline-block; width: 31%; margin:auto; text-align:left;">
              ...
              <div class="main-form cp-form">
                <div style="display:inline-block; width: 55%; margin:auto; text-align:left;">
                  <input type="text" id="coupon_code" name="coupon_code" placeholder="Agregar cupón de descuento" style="width:80%; padding:10px;" />
                </div>
                <div style="display:inline-block; width: 42%; margin:auto; text-align:left;">
                  <button id="paypal-button-container" class="couponBtn form-btn">Aplicar</button>
                </div>
              </div>
          </div>
        </div>
...
<script>
  ...
  const coupon_btn = document.querySelector('.couponBtn');
    ...
    function total_amount(discount){
      var product_price = <?php echo $product_price; ?>;
      if(discount > 0){
        var discounted = (discount/100) * product_price;
      } else {
        var discounted = 0;
      }
    }
